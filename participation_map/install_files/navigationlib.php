...
class settings_navigation extends navigation_node {
    ...
    protected function load_course_settings($forceopen = false) {
		...
		// Participation Map
		if (has_capability('moodle/course:update', $coursecontext)) {
			$BushGrapherURL = $CFG->wwwroot."/participation_map?course=".$course->id;
			$coursenode->add("Participation Map", $BushGrapherURL, self::TYPE_SETTING, null, 'participation_map', new pix_icon('i/mini_bushgrapher', ''));
		}
